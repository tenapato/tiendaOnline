						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown">
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link" href="categorias.html">Comprar por Categorias</a></li>
									<li class="nav-item"><a class="nav-link" href="checkout.html">Checkout</a></li>
									<li class="nav-item"><a class="nav-link" href="cart.html">Carrito</a></li>
									<li class="nav-item"><a class="nav-link" href="confirmation.html">Confirmacion</a></li>
								</ul>
							</li>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                            ...
                            <div class="col-md-6 form-group p_star">
                                <input type="text" class="form-control" id="apellido" name="name">
                            ...
                            <div class="col-md-6 form-group p_star">
                                <input type="text" class="form-control" id="psw" name="compemailany">
                                <span class="placeholder" data-placeholder="Contraseña"></span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="order_box">
                            ...
                            <a class="primary-btn" href="index.html">Crear Cuenta</a>
                        </div>
                    </div>
                </div>
            </div>
